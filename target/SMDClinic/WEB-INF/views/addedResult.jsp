...
<body ng-app="homeNav">
	<div class="{{bodyClass}}">
		...
		<div id="HTMLContainer" class="container marketing">
			<div class="container">
				<h2 class="featurette-heading">Added Result</h2>
						<div class="row featurette">
				<div class="col-lg-2">
						<div class="card">
							<div class="card-block">
								<h4 class="card-title"><b>Code:</b>${result.code}</h4>
								<p class="card-text"><b>Exam Code:</b>${result.exam.code}</p>
							</div>
							<ul class="list-group list-group-flush">
							<c:forEach var="res" items="${result.resultsRows}" varStatus="status">
								<li class="list-group-item"><b>Indicator:</b>${res.description.description}<br>
								<b>Value</b>${res.value }
								</li>
							</c:forEach>
							</ul>
							<div class="card-block">
								<a href="${pageContext.request.contextPath}/adminArea"
									class="card-link"><button class="btn btn-success btn-lg">Admin
										Panel</button></a> <a
									href="${pageContext.request.contextPath}/newResult"
