...
<body ng-app="homeNav">
	<div class="{{bodyClass}}">
		...
		<div id="HTMLContainer" class="container marketing">
			<div class="container">
				<h2 class="featurette-heading">Added Exam</h2>
						<div class="row featurette">
				<div class="col-lg-2">
						<div class="card">
							<div class="card-block">
								<h4 class="card-title"><b>Code:</b>${exam.code}</h4>
								<p class="card-text"><b>Exam Typology:</b>${exam.examTypology.name}</p>
							</div>
							<ul class="list-group list-group-flush">
								<li class="list-group-item"><b>Booking Date:</b>${exam.bookingDate}</li>
								<li class="list-group-item"><b>Exam Date:</b>${exam.examDate}</li>
								<li class="list-group-item"><b>Doctor:</b>${exam.doctor.name} ${exam.doctor.surname}</li>
							</ul>
							<div class="card-block">
								<a href="${pageContext.request.contextPath}/adminArea"
									class="card-link"><button class="btn btn-success btn-lg">Admin
										Panel</button></a> <a
									href="${pageContext.request.contextPath}/addExam"
